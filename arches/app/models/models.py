...
class CardModel(models.Model):
    ...
    nodegroup = models.ForeignKey('NodeGroup', on_delete=models.CASCADE, db_column='nodegroupid')
...
class ConstraintModel(models.Model):
    ...
    card = models.ForeignKey('CardModel', on_delete=models.CASCADE, db_column='cardid')
...
class CardXNodeXWidget(models.Model):
    ...
    node = models.ForeignKey('Node', on_delete=models.CASCADE, db_column='nodeid')
    card = models.ForeignKey('CardModel', on_delete=models.CASCADE, db_column='cardid')
    widget = models.ForeignKey('Widget', on_delete=models.CASCADE, db_column='widgetid')
    config = JSONField(blank=True, null=True, db_column='config')
...
class Concept(models.Model):
    ...
    nodetype = models.ForeignKey('DNodeType', on_delete=models.CASCADE, db_column='nodetype')
...
class DDataType(models.Model):
    ...
    defaultwidget = models.ForeignKey(db_column='defaultwidget', on_delete=models.CASCADE, to='models.Widget', null=True)
    defaultconfig = JSONField(blank=True, null=True, db_column='defaultconfig')
...
class Edge(models.Model):
    ...
    domainnode = models.ForeignKey('Node', on_delete=models.CASCADE, db_column='domainnodeid', related_name='edge_domains')
    rangenode = models.ForeignKey('Node', on_delete=models.CASCADE, db_column='rangenodeid', related_name='edge_ranges')
    graph = models.ForeignKey('GraphModel', on_delete=models.CASCADE, db_column='graphid', blank=True, null=True)
...
class GraphModel(models.Model):
    ...
    ontology = models.ForeignKey('Ontology', on_delete=models.CASCADE, db_column='ontologyid', related_name='graphs', null=True, blank=True)
...
class NodeGroup(models.Model):
    ...
    parentnodegroup = models.ForeignKey('self', on_delete=models.CASCADE, db_column='parentnodegroupid', blank=True, null=True)  #Allows nodegroups within nodegroups
...
class Node(models.Model):
    ...
    nodegroup = models.ForeignKey(NodeGroup, on_delete=models.CASCADE, db_column='nodegroupid', blank=True, null=True)
    graph = models.ForeignKey(GraphModel, on_delete=models.CASCADE, db_column='graphid', blank=True, null=True)
    config = JSONField(blank=True, null=True, db_column='config')
...
class Ontology(models.Model):
    ...
    parentontology = models.ForeignKey('Ontology', on_delete=models.CASCADE, db_column='parentontologyid', related_name='extensions', null=True, blank=True)
...
class OntologyClass(models.Model):
    ...
    ontology = models.ForeignKey('Ontology', on_delete=models.CASCADE, db_column='ontologyid', related_name='ontologyclasses')
...
class Relation(models.Model):
    conceptfrom = models.ForeignKey(Concept, on_delete=models.CASCADE, db_column='conceptidfrom', related_name='relation_concepts_from')
    conceptto = models.ForeignKey(Concept, on_delete=models.CASCADE, db_column='conceptidto', related_name='relation_concepts_to')
    relationtype = models.ForeignKey(DRelationType, on_delete=models.CASCADE, db_column='relationtype')
...
class Resource2ResourceConstraint(models.Model):
    ...
    resourceclassfrom = models.ForeignKey(Node, on_delete=models.CASCADE, db_column='resourceclassfrom', blank=True, null=True, related_name='resxres_contstraint_classes_from')
    resourceclassto = models.ForeignKey(Node, on_delete=models.CASCADE, db_column='resourceclassto', blank=True, null=True, related_name='resxres_contstraint_classes_to')
...
class ResourceXResource(models.Model):
    ...
    resourceinstanceidfrom = models.ForeignKey('ResourceInstance', on_delete=models.CASCADE, db_column='resourceinstanceidfrom', blank=True, null=True, related_name='resxres_resource_instance_ids_from')
    resourceinstanceidto = models.ForeignKey('ResourceInstance', on_delete=models.CASCADE, db_column='resourceinstanceidto', blank=True, null=True, related_name='resxres_resource_instance_ids_to')
...
class TileModel(models.Model):  # Tile
    ...
    parenttile = models.ForeignKey('self', on_delete=models.CASCADE, db_column='parenttileid', blank=True, null=True)
...
class Value(models.Model):
    ...
    concept = models.ForeignKey('Concept', on_delete=models.CASCADE, db_column='conceptid')
    valuetype = models.ForeignKey(DValueType, on_delete=models.CASCADE, db_column='valuetype')
    value = models.TextField()
    language = models.ForeignKey(DLanguage, on_delete=models.CASCADE, db_column='languageid', blank=True, null=True)
...
class TileserverLayer(models.Model):
    ...
    config = JSONField()
    map_layer = models.ForeignKey('MapLayer', on_delete=models.CASCADE, db_column='map_layerid')
    map_source = models.ForeignKey('MapSource', on_delete=models.CASCADE, db_column='map_sourceid')
...
class MobileSurveyModel(models.Model):
    ...
    lasteditedby = models.ForeignKey(User, on_delete=models.CASCADE, related_name='lasteditedby')
